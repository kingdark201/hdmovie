...
export async function addUser(user) {
    try {
        const response = await fetch('https://hdmoviebe.onrender.com/api/users/add', {
            method: 'POST',
            headers: {
...
export async function editUser(user, token) {
    try {
        const response = await fetch(`https://hdmoviebe.onrender.com/api/users/edit`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                ...getAuthHeader(token),
...
export async function deleteUser(token) {
    try {
        const response = await fetch(`https://hdmoviebe.onrender.com/api/users/delete`, {
            method: 'DELETE',
            headers: {
                ...getAuthHeader(token),
            },
...
export async function login(username, password) {
    try {
        const response = await fetch('https://hdmoviebe.onrender.com/api/users/login', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
